...
if MULTI_NATIVE_WINDOW == 'true':
  COMMON_CCFLAGS = COMMON_CCFLAGS + ' -DMULTI_NATIVE_WINDOW=1 '
...
os.environ['MULTI_NATIVE_WINDOW'] = MULTI_NATIVE_WINDOW;
